...
export default function GetQuoteForm() {
    ...
    return (
        <>
            ...
            <header>
                <h1 className='text-[35px] font-bold text-center mt-[50px] mb-5 '>Get Your Free <span className='text-green-500'>Roofing</span> Quote Today!</h1>
                <p className='text-center w-[85vw] md:w-[60vw] m-auto mt-3'>Trusted by Texas homeowners, we provide fast, reliable, and transparent roofing estimates. Tell us your requirements and we’ll get back to you within 24 hours.</p>
            </header>
            <form
                ref={formRef}
            ...
            >
                <h2 className="text-3xl font-bold text-green-500 mb-4 text-center">Get a Free Quote</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Address */}
                    <div className="flex flex-col">
                        <label htmlFor="address" className="font-semibold text-green-500 mb-1">Address</label>
                        <input
                            id="address"
                            type="text"
                            name="address"
                    ...
                    {/* City */}
                    <div className="flex flex-col">
                        <label htmlFor="city" className="font-semibold text-green-500 mb-1">City</label>
                        <input
                            id="city"
                            type="text"
                            name="city"
                    ...
                    {/* Zip Code */}
                    <div className="flex flex-col">
                        <label htmlFor="zip" className="font-semibold text-green-500 mb-1">Zip Code</label>
                        <input
                            id="zip"
                            type="text"
                            name="zip"
                ...
                <button
                    ...
                    className="w-full bg-green-600 cursor-pointer text-white py-3 rounded-lg font-semibold hover:scale-105 transition-transform duration-200 hover:bg-green-700"
                >
            ...
            <section className="w-full py-20 bg-gray-50 mt-[50px] mb-5">
                <div className="max-w-5xl mx-auto px-5">
                    ...
                    {/* Step 1 */}
                    <div className="mb-10">
                        <h3 className="text-2xl font-bold text-green-500">01.</h3>
                    ...
                    {/* Step 2 */}
                    <div className="mb-10">
                        <h3 className="text-2xl font-bold text-green-500">02.</h3>
                    ...
                    {/* Step 3 */}
                    <div>
                        <h3 className="text-2xl font-bold text-green-500">03.</h3>
